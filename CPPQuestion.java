...
class CPPQuestion extends JFrame implements ActionListener{
//Radio button
...
public CPPQuestion(){
	...
	//label
	question1 = new JLabel("Choose the operator which cannot be overloaded. ");
	question2 = new JLabel("Which data type can be used to hold a wide character in C++?");
	question3 = new JLabel("A protected member of the class in accessible in");
	question4 = new JLabel("What is the full form of STL?");
	question5 = new JLabel("A single line comment in C++ language source code can begin with ");
	...
	o5 = new JLabel("unsigned char");
	o6 = new JLabel("int");
	o7 = new JLabel("wchar_t");
	o8 = new JLabel("None of abouve");
	
	//ans wchar_t
	
	o9 = new JLabel("Only same class");
	o10 = new JLabel("Same class & derived class");
	o11 = new JLabel("Outside the class");
	o12 = new JLabel("None of above");
	
	//ans immutable
	
	o13 = new JLabel("Standard template library.");
	o14 = new JLabel("System template library.");
	o15 = new JLabel("Standard topics library.");
	o16 = new JLabel("None of above");
...
public void  actionPerformed (ActionEvent  c)
{
  ...
  JOptionPane.showMessageDialog(null,"you have scored : 3");		
